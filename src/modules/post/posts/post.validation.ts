...
export const postCommentIdSchema = {
...
export const createPostSchema = {
  body: z.object({ content: optionalContent }).strip(),
};
  ...
  body: z
    .object({
      ...
      removeImagePublicIds: z
        .union([z.array(z.string().min(1)).max(10), z.string()])
        .optional(),
      replaceImages: z.union([z.boolean(), z.string()]).optional(),
    })
    .strip(),
};
export const commentSchema = {
  body: z.strictObject({ content: z.string().trim().min(1).max(2000) }),
};
